...
.defer(d3.json, "worldmap.geojson")
.defer(d3.csv, "population-and-demography.csv" ,function (d) {
  map.set(d.name, +d.population);
})
.await(drawMap);
...
.domain([10000, 1000000, 3000000, 10000000, 20000000, 80000000, 100000000, 300000000, 2000000000])
    ...
    // Draws the paths
      ...
      .on("mouseover", function(d)  {
        ...
        tooltip
          ...
          .transition()
          .duration(300)
          .text("Population " + d.properties.name + ': ' + d.population);
    }
